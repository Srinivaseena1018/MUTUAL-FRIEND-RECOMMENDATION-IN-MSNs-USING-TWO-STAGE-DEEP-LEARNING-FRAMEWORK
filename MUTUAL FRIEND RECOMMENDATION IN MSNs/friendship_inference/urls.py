"""friendship_inference_in_mobile_social_networks URL Configuration
...
from friendship_inference_in_mobile_social_networks import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Friendship_Inference_Matched_Status/$', remoteuser.Predict_Friendship_Inference_Matched_Status, name="Predict_Friendship_Inference_Matched_Status"),
    ...
    url(r'^View_Predicted_Friendship_Inference_Matched_Status_Ratio/$', serviceprovider.View_Predicted_Friendship_Inference_Matched_Status_Ratio, name="View_Predicted_Friendship_Inference_Matched_Status_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Friendship_Inference_Matched_Status/$', serviceprovider.View_Predicted_Friendship_Inference_Matched_Status, name="View_Predicted_Friendship_Inference_Matched_Status"),
