...
ROOT_URLCONF = 'friendship_inference_in_mobile_social_networks.urls'
...
WSGI_APPLICATION = 'friendship_inference_in_mobile_social_networks.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'friendship_inference_in_mobile_social_networks',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
