...
--
-- Host: localhost
-- Generation Time: Sep 13, 2023 at 08:23 AM
...
--
-- Database: `friendship_inference_in_mobile_social_networks`
--
CREATE DATABASE IF NOT EXISTS `friendship_inference_in_mobile_social_networks` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `friendship_inference_in_mobile_social_networks`;
...
(16, 'Convolutional Neural network--CNN', '73.57142857142858'),
(17, 'SVM', '83.57142857142857'),
(18, 'Logistic Regression', '84.42857142857143'),
(19, 'Decision Tree Classifier', '82.14285714285714'),
(20, 'SGD Classifier', '82.14285714285714');
...
(8, 'No Match Found', '80.0'),
(9, 'Match Found', '20.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_friendship_inference`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_friendship_inference` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `FGender` varchar(300) NOT NULL,
  `FDOB` varchar(300) NOT NULL,
  `FCity` varchar(300) NOT NULL,
  `FCountry` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `remote_user_predict_friendship_inference`
--

INSERT INTO `remote_user_predict_friendship_inference` (`id`, `Fid`, `Name`, `Gender`, `DOB`, `Interests`, `City`, `Country`, `FName`, `FGender`, `FDOB`, `FCity`, `FCountry`, `Prediction`) VALUES
(1, '172.217.12.206-10.42.0.151-443-52060-17', 'Christina Parker', 'Female', '30-08-63', '''Finance and investments'', ''Health and wellness''', 'Roeselare', 'Belgium', 'Jeffrey Free', 'Female', '05-03-84', 'Dalaman', 'Turkey', 'No Match Found'),
(2, '172.217.3.99-10.42.0.42-443-33800-6', 'Cody Watson', 'Female', '07-03-86', '''Cars and automobiles'', ''Music''', 'Daterson', 'Japan', 'Richard Hicks', 'Male', '18-11-77', 'Sitangkai', 'Philippines', 'Match Found'),
(3, '182.254.5.234-10.42.0.151-80-59385-6', 'Doris Vinci', 'Male', '17-08-02', '''Music'', ''Sports'', ''Movies''', 'YÅnan-Å­p', 'North Korea', 'Wade Yocum', 'Male', '28-10-80', 'Tradate', 'Italy', 'No Match Found'),
(4, '10.42.0.211-123.125.29.220-52039-80-6', 'Hester Avery', 'Female', '01-05-82', '''Parenting and family'', ''Education and learning'', ''Gaming'', ''Cooking''', 'Rumia', 'Poland', 'Mary Zeiler', 'Female', '06-07-94', 'Canby', 'United States', 'No Match Found'),
(5, '10.42.0.211-118.178.172.20-48210-80-6', 'Anna Whitfield', 'Female', '05-01-01', '''Movies'', ''Social causes and activism'', ''Outdoor activities''', 'Gaoliu', 'China', 'Maria Mattison', 'Male', '27-04-02', 'Wellington', 'United Kingdom', 'No Match Found');
